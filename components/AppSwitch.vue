<template>
  <div class="sidearea">
    <div class="can-toggle demo-rebrand-2">
      ...
      <label for="e">
        <div class="can-toggle__switch" data-checked="Sales" data-unchecked="All"></div>
      </label>
    </div>
  </div>
</template>
...
.can-toggle {
  ...
  *:after {
  ...
  &.demo-rebrand-2 {
    ...
    position: relative;
    left: 50px;
    @include can-toggle-branding (rgba(150, 150, 150, 0.35), rgba(252, 0, 0, 0.3), rgba(white, 0.7), ease);
    @include can-toggle-appearance (150px, 30px, 22px, 3px, 0, 12px, 0 2px 4px rgba(black, 0.2));
  }
}
